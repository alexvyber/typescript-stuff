...
When status is loading, data or error are never present.
...
For many devs, this is going to be tricky to figure out. Both data and error can exist on State, so why am I getting errors?
...
This strictness is a feature, not a bug. By ensuring you can only access data when the status equals success, you're encouraged to think of your app in terms of its states, and only access data in the states it's available.
